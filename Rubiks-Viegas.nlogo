...
to setup
  set resuelto (list [1 2 3 4 5 6 7 8] [1 1 1 1 1 1 1 1])
  set elementales (list "U" "D" "F" "B" "L" "R")

end

to swap
  ;funcion que dada una lista con valores en el indice que caya que swapear
  ;Ejemplo:  [- - 1 -] [1 3 4 5] siendo la primera la lista de swap y la segunda la lista que queremos aplicarle el swap
  ;la funcion devolveria [4 3 1 5] (contando que empezamos en 1) o [1 4 3 5] (si empezamos en 0)
end
